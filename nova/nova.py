...
def set_config_file(management_ip, user='nova', password='stackops',
    ...
    set_property('network_api_class', 'nova.network.neutronv2.api.API')
    set_property('dmz_cidr', '169.254.169.254/32')
    set_property('metadata_listen', '0.0.0.0')
    set_property('metadata_listen_port', '8775')
    set_property('service_neutron_metadata_proxy', 'True')
    set_property('neutron_metadata_proxy_shared_secret', 'password')
    set_property('neutron_auth_strategy', 'keystone')
